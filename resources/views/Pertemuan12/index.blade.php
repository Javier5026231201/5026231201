...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Kulina : Cathering Karyawan perusahaan</title>
   ...
   <body>
         ...
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div class="call_btn"><a href="https://api.whatsapp.com/send/?phone=628112657575&text&type=phone_number&app_absent=0"><i class="fa fa-phone" aria-hidden="true"></i><span class="padding_left10">Call : +1234567890</span></a></div>
               </div>
            </nav>
         </div>
      </div>
      ...
      <div class="container">
         <img src="https://plazamedis.id/wp-content/uploads/2025/05/Peran-Perusahaan-dalam-Mendukung-Gizi-Karyawan.webp" alt="Norway" style="width:100%; background-color: black;">
         <div class="text-block">
           <p style="line-height: 8px;">Solusi Cerdas Manajemen Kebutuhan Makanan Perusuhaan</p>
           <p style="line-height: 8px;">Nikmati kemudahan pemesanan makan, pengiriman andal, dan efisiensi administrasi dalam satu platform Kulina.</p>
         </div>
       </div>
      ...
      <div class="banner_section layout_padding">
         <div class="container">
            <img src="https://plazamedis.id/wp-content/uploads/2025/05/Peran-Perusahaan-dalam-Mendukung-Gizi-Karyawan.webp" class="banner_img">
                  ...
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-sm-12">
                           ...
                           <div class="contact_bt"><a href="contact.html">Read More</a></div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="service_section layout_padding">
         <div class="container">
            <h1 class="service_taital">Mengapa kami Cathering Terbaik</h1>
         ...
         <div class="container">
            ...
            <div class="price_section_2">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <h3 class="first_price_text">Secound Price</h3>
                     <div class="price_box">
                        <div class="taital_main">
                     ...
                     <div class="client_section_2">
                        <div class="client_main">
                           ...
                           <div class="client_right">
                              <h3 class="name_text">Jonyro <span style="float: right;"><img src="images/quick-icon.png"></span></h3>
                        ...
                        <div class="client_main_2">
                           <div class="client_right_2">
                              <h3 class="name_text">Jonyro <span style="float: left;"><img src="images/quick-icon.png"></span></h3>
                              <p class="dolor_text">Voluptate</p>
                              <p class="lorem_text">consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation  eu </p>
                           </div>
